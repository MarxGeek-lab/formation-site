  ...
  return (
    <div className='flex justify-end items-center flex-wrap pli-6 border-bs bs-auto plb-[12.5px] gap-2'>
      {/* <Typography color='text.disabled'>
        ...
        sur ${Math.min((table.getState().pagination.pageIndex + 1) * table.getState().pagination.pageSize, table.getFilteredRowModel().rows.length)} pour ${table.getFilteredRowModel().rows.length} entries`}
      </Typography> */}
      <Pagination
        shape='circular'
        color='primary'
