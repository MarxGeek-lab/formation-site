        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <FormControl error={Boolean(errors.checkbox)} className='is-full mbe-6'>
            <Controller
              ...
              rules={{ required: true }}
              render={({ field }) => (
                <FormControlLabel control={<Checkbox {...field} />} label='Je confirme la désactivation de mon compte' />
              )}
            />
            {errors.checkbox && <FormHelperText error>Veuillez confirmer que vous souhaitez supprimer votre compte</FormHelperText>}
          </FormControl>
