...
import { roles, statusValidateUser } from '@/data/constant'
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('role', {
        ...
        cell: ({ row }) => (
          <div className='flex flex-col items-start gap-1'>
             <Chip
              label={roles[row.original?.role]?.title}
              variant='tonal'
              size='small'
            />
          </div>
      ...
      columnHelper.accessor('status', {
        ...
        cell: ({ row }) => (
          <Chip
            label={statusValidateUser[row.original?.status]?.title}
            color={statusValidateUser[row.original?.status]?.color}
            variant='tonal'
            size='small'
          />
        )
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            <Button href={`/${locale}/dashboards/users/details/${row.original?._id}`}>
