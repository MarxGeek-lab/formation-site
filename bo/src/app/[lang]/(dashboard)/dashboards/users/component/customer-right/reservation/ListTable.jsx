...
export const paymentStatus = {
  1: { text: 'completed', color: 'success', colorClassName: 'text-success' },
...
const ListTable = ({ orderData }) => {
  ...
  const statusValidate = {
    ...
    progress: { title: 'En cours', color: 'success' },
    cancelled: { title: 'Annulé', color: 'error' }
  }
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            <Button href={`/${locale}/dashboards/reservations/details/${row.original._id}`}>
