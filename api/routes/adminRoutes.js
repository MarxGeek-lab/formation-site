...
router.post('/category', auth, upload.single('images'), categoryController.createCategory);
...
router.put('/category/:id', auth, upload.single('images'), categoryController.updateCategory);
